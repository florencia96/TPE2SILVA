...
class comentariosModel{
     ...
     */
    public function insert($comentario, $nota,$id_viaje) {
        $query = $this->db->prepare("INSERT INTO comentario (comentario, nota, id_viaje) VALUES (?,?,?)");
        $query->execute([$comentario, $nota, $id_viaje]);
